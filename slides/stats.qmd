...
subtitle: |
  **[Chapter 3: Manipulating structured data]{.orange}**
authors: |
...
1. We convert the standard _dataframe_ to `tibble`
2. We keep only gas stations (values `B316` of `TYPEQU`)
3. We define `DEP` as a stratification variable to define groups
...
- The essential _package_ for making graphics ❤️;
